...
(function (root, factory) {
   ...
   */
  function ucimws(url, protocols, options) {
    var self = this
    //websocket url
    this.url = url
    //websocket 状态
  ...
  ucimws.prototype.openEx = function (hostUrl) {
    this.url = hostUrl
    this.open()
  }
  ...
  ucimws.prototype.onconnecting = func
  ucimws.prototype.onerror = func
  ucimws.prototype.onopen = func
  ucimws.prototype.onmessage = func

  /**
   * [send 发送 websocket 消息]
   * @param 参数 data 为发消息的内容
   */
  ucimws.prototype.send = function (data) {
   ...
   */
  ucimws.prototype.close = function (code, reason) {
    // 默认CLOSE_NORMAL代码
  ...
  /**
     ...
     */
  ucimws.prototype.open = function () {
    var self = this
    var wsocket = new WebSocket(this.url, this.protocol || [])
    eventTarget.dispatchEvent(generateEvent('connecting'))
    wsocket.onopen = function () {
      self.protocol = ucimws.protocol
