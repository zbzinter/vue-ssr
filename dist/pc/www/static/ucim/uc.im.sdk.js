  ...
  this.onProcess = function (arrayBuffer, handlerObj) {
    ...
    if (sid == 2 && cid == 2 && handlerObj.onLogin && typeof handlerObj.onLogin === 'function') {
      ...
      if (resCode == 200) {
        ...
        if (retryConn) {
          ucim.currentConnection.sendMsg(new ucim.UcEnterRoomPacket(userInfo.userId, userInfo.userNick, userInfo.roomId))
          retryConn = false
        }
      ...
      //var sensitiveWord = getSensitiveWord("http://localIp/file?" + param, "");
